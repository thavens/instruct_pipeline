...
tokenizer = AutoTokenizer.from_pretrained(f"/storage_fast/models/michael_lavery/{int(args.p*100)}/checkpoint-{args.ckpt}")
...
llm = LLM(f"/storage_fast/models/michael_lavery/{int(args.p*100)}/checkpoint-{args.ckpt}")
